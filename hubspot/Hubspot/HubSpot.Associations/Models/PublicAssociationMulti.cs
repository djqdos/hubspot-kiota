...
namespace True.Services.HubSpot.Associations.Models {
    public class PublicAssociationMulti : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public True.Services.HubSpot.Associations.Models.Paging? Paging { get; set; }
#nullable restore
#else
        public True.Services.HubSpot.Associations.Models.Paging Paging { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new PublicAssociationMulti and sets the default values.
        /// </summary>
        public PublicAssociationMulti() {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"paging", n => { Paging = n.GetObjectValue<True.Services.HubSpot.Associations.Models.Paging>(True.Services.HubSpot.Associations.Models.Paging.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<True.Services.HubSpot.Associations.Models.Paging>("paging", Paging);
