...
namespace True.Services.HubSpot.Associations.Crm.V3.Associations.Item.Item.Types {
    /// <summary>
...
#nullable enable
        public async Task<CollectionResponsePublicAssociationDefinitionNoPaging?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CollectionResponsePublicAssociationDefinitionNoPaging> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            var requestInfo = ToGetRequestInformation(requestConfiguration);
            return await RequestAdapter.SendAsync<CollectionResponsePublicAssociationDefinitionNoPaging>(requestInfo, CollectionResponsePublicAssociationDefinitionNoPaging.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// List all the valid association types available between two object types
        /// </summary>
...
#nullable restore
        ...
        public class TypesRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
