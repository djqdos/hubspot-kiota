...
namespace True.Services.HubSpot.Pipelines.Models {
    ...
    /// </summary>
    public class PipelineStagePatchInput : IAdditionalDataHolder, IParsable {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public PipelineStagePatchInput_metadata? Metadata { get; set; }
#nullable restore
#else
        public PipelineStagePatchInput_metadata Metadata { get; set; }
#endif
        /// <summary>
        /// Instantiates a new PipelineStagePatchInput and sets the default values.
        /// </summary>
        ...
        public static PipelineStagePatchInput CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PipelineStagePatchInput();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers() {
            return new Dictionary<string, Action<IParseNode>> {
                ...
                {"metadata", n => { Metadata = n.GetObjectValue<PipelineStagePatchInput_metadata>(PipelineStagePatchInput_metadata.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<PipelineStagePatchInput_metadata>("metadata", Metadata);
