...
using System;
using True.Services.HubSpot.Pipelines.Crm.V3.Pipelines;
namespace True.Services.HubSpot.Pipelines.Crm.V3 {
    /// <summary>
    ...
    public class V3RequestBuilder : BaseRequestBuilder {
        ...
        public PipelinesRequestBuilder Pipelines { get =>
            new PipelinesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
