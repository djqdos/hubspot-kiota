...
using System;
using True.Services.HubSpot.Tickets.Crm.V3.Objects.Tickets.Batch;
using True.Services.HubSpot.Tickets.Crm.V3.Objects.Tickets.GdprDelete;
using True.Services.HubSpot.Tickets.Crm.V3.Objects.Tickets.Item;
using True.Services.HubSpot.Tickets.Crm.V3.Objects.Tickets.Merge;
using True.Services.HubSpot.Tickets.Crm.V3.Objects.Tickets.Search;
using True.Services.HubSpot.Tickets.Models;
namespace True.Services.HubSpot.Tickets.Crm.V3.Objects.Tickets {
    /// <summary>
    ...
    public class TicketsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the True.Services.HubSpot.Tickets.crm.v3.objects.tickets.item collection</summary>
