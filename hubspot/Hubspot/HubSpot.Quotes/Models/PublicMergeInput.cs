...
namespace True.Services.HubSpot.Quotes.Models {
    public class PublicMergeInput : IAdditionalDataHolder, IParsable {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new PublicMergeInput and sets the default values.
        /// </summary>
        ...
        public static PublicMergeInput CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new PublicMergeInput();
        }
        /// <summary>
