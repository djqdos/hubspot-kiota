...
namespace True.Services.HubSpot.Quotes.Crm.V3.Objects.Quotes.Batch.Create {
    /// <summary>
    /// Builds and executes requests for operations under \crm\v3\objects\quotes\batch\create
    /// </summary>
    public class CreateRequestBuilder : BaseRequestBuilder {
        ...
        public CreateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crm/v3/objects/quotes/batch/create", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CreateRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crm/v3/objects/quotes/batch/create", rawUrl) {
        }
        /// <summary>
