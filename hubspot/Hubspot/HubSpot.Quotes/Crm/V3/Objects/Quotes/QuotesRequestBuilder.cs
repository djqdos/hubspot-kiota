...
using System;
using True.Services.HubSpot.Quotes.Crm.V3.Objects.Quotes.Batch;
using True.Services.HubSpot.Quotes.Crm.V3.Objects.Quotes.GdprDelete;
using True.Services.HubSpot.Quotes.Crm.V3.Objects.Quotes.Item;
using True.Services.HubSpot.Quotes.Crm.V3.Objects.Quotes.Merge;
using True.Services.HubSpot.Quotes.Crm.V3.Objects.Quotes.Search;
using True.Services.HubSpot.Quotes.Models;
namespace True.Services.HubSpot.Quotes.Crm.V3.Objects.Quotes {
    /// <summary>
    /// Builds and executes requests for operations under \crm\v3\objects\quotes
    /// </summary>
    public class QuotesRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the True.Services.HubSpot.Quotes.crm.v3.objects.quotes.item collection</summary>
        /// <param name="position">Unique identifier of the item</param>
        public WithQuoteItemRequestBuilder this[string position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("quoteId", position);
            return new WithQuoteItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
        ...
        public QuotesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crm/v3/objects/quotes{?limit*,after*,properties*,propertiesWithHistory*,associations*,archived*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new QuotesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public QuotesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crm/v3/objects/quotes{?limit*,after*,properties*,propertiesWithHistory*,associations*,archived*}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<CollectionResponseSimplePublicObjectWithAssociationsForwardPaging?> GetAsync(Action<RequestConfiguration<QuotesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CollectionResponseSimplePublicObjectWithAssociationsForwardPaging> GetAsync(Action<RequestConfiguration<QuotesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<QuotesRequestBuilderGetQueryParameters>>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<QuotesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public QuotesRequestBuilder WithUrl(string rawUrl) {
            return new QuotesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Read a page of quotes. Control what is returned via the `properties` query param.
        /// </summary>
        public class QuotesRequestBuilderGetQueryParameters {
...
#nullable restore
        ...
        public class QuotesRequestBuilderGetRequestConfiguration : RequestConfiguration<QuotesRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class QuotesRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
