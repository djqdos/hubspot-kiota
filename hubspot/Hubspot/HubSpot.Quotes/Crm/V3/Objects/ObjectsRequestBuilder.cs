...
using System;
using True.Services.HubSpot.Quotes.Crm.V3.Objects.Quotes;
namespace True.Services.HubSpot.Quotes.Crm.V3.Objects {
    /// <summary>
    ...
    public class ObjectsRequestBuilder : BaseRequestBuilder {
        ...
        public QuotesRequestBuilder Quotes { get =>
            new QuotesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
