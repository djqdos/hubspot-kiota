...
using System;
using True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.Batch.Archive;
using True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.Batch.Create;
using True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.Batch.Read;
using True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.Batch.Update;
namespace True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.Batch {
    /// <summary>
