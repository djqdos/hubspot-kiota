...
using System;
using True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.Batch;
using True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.GdprDelete;
using True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.Item;
using True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.Merge;
using True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.Search;
using True.Services.HubSpot.Companies.Models;
namespace True.Services.HubSpot.Companies.Crm.V3.Objects.Companies {
    /// <summary>
    ...
    public class CompaniesRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the True.Services.HubSpot.Companies.crm.v3.objects.companies.item collection</summary>
...
#nullable enable
        public async Task<CollectionResponseSimplePublicObjectWithAssociationsForwardPaging?> GetAsync(Action<RequestConfiguration<CompaniesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CollectionResponseSimplePublicObjectWithAssociationsForwardPaging> GetAsync(Action<RequestConfiguration<CompaniesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        public class CompaniesRequestBuilderGetRequestConfiguration : RequestConfiguration<CompaniesRequestBuilderGetQueryParameters> {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class CompaniesRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> {
        }
    }
}
