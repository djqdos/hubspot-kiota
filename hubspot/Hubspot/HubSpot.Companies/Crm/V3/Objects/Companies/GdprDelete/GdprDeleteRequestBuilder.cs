...
namespace True.Services.HubSpot.Companies.Crm.V3.Objects.Companies.GdprDelete {
    /// <summary>
    /// Builds and executes requests for operations under \crm\v3\objects\companies\gdpr-delete
    /// </summary>
    public class GdprDeleteRequestBuilder : BaseRequestBuilder {
        ...
        public GdprDeleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crm/v3/objects/companies/gdpr-delete", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GdprDeleteRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public GdprDeleteRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/crm/v3/objects/companies/gdpr-delete", rawUrl) {
        }
        /// <summary>
